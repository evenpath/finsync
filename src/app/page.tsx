      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-lg border-b">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <Link href="/" className="flex items-center space-x-3">
            ...
            <h1 className="text-2xl font-bold text-gray-900 font-headline">Floz</h1>
          </Link>
      ...
      <section className="bg-white py-16 md:py-24">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto mt-6 mb-8">
            Floz automates your business operations with intelligent AI agents.
      ...
      <section className="py-20 bg-primary">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-purple-100 mb-8">
            Join hundreds of businesses that have streamlined their workflows with Floz.
          </p>
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Link href="/partner/signup">
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <h3 className="text-xl font-bold font-headline">Floz</h3>
              </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2025 Floz. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
