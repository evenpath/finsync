  ...
  return (
    <div className="h-full flex flex-col">
       <div className="flex-1 flex overflow-hidden">
        {/* Workflow Canvas */}
        <div className="flex-1 relative bg-secondary/50 overflow-auto p-8">
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold font-headline">{workflowData.title}</h2>
                        <p className="text-muted-foreground">Design your automated workflow by adding and connecting steps.</p>
                    </div>
                </div>
                <div className="flex items-center gap-2">
                    <Button variant="outline"><Play className="w-4 h-4 mr-2"/> Test</Button>
                    <Button onClick={() => onSave(workflowData)}><Save className="w-4 h-4 mr-2"/> Save Workflow</Button>
                </div>
            </div>

          {/* Step Library Toggle & Canvas */}
          <div className="relative">
            ...
            {showStepLibrary && (
              <div className="absolute top-12 left-0 w-80 bg-card rounded-lg shadow-lg border z-20 max-h-[calc(100vh-12rem)] overflow-y-auto">
                <CardHeader>
            ...
            <div className="pt-16">
              {workflowData.steps.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-muted-foreground text-center py-24 border-2 border-dashed rounded-lg">
                  <Layers className="w-16 h-16 mb-4" />
                  <h3 className="text-xl font-semibold mb-2 text-foreground">Start Building Your Workflow</h3>
                  <p className="mb-6 max-w-md">
                    Click "Add Step" to begin creating your automation pipeline.
                  </p>
